    ...
    <div class="container">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="registrationform">
                {!! $form->open(['route' => 'student.auth.lost.post', 'method' => 'post', 'class' => 'form-horizontal']) !!}
                <fieldset>
...
@section('head-css-post')
    @parent
    <link rel="stylesheet" href="{{asset('/assets/css/layout/student/auth/lost/student_auth_lost_theme_1.min.css')}}">
@endsection

@section('body-js-lower-post')
    @parent
    <script type="text/javascript" src="{{asset('/assets/js/layout/student/auth/lost/student_auth_lost_theme_1.min.js')}}"></script>
@endsection

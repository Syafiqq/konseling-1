                    ...
                    <div class="col-sm-6 col-sm-offset-3 text-center centered">
                        <div class="btn-group" role=group aria-label="question-track">
                            ...
                            @else
                                ...
                                ?>
                                {!! link_to_route('student.course.start.edit', '<< Sebelumnya', [$prev->getAttribute('question')], ['class'=> "btn btn-$isCompleted"]); !!}
                            @endif
                            <?php
                            ...
                            @else
                                ...
                                ?>
                                {!! link_to_route('student.course.start.edit', 'Selanjutnya >>', [$next->getAttribute('question')], ['class'=> "btn btn-$isCompleted"]); !!}
                            @endif
                        </div>
                    </div>
                </div>
